...
/* TaskBundle:Tasks:edit.html.twig */
class __TwigTemplate_0c5537a857b41f90b4f898fa0d90179ac7bc90e936fdcd404cceee0583126cdc extends Twig_Template
{
    ...
    <div class=\"row-fluid\">
        ...
        echo "
                <span class=\"help-inline\">";
        // line 25
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "leader"), 'errors', array("disabled" => "true"));
        echo "</span>
            </div>
        </div>
        ...
        <div class=\"control-group primary\">
                    ";
        // line 106
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "duetimestamp"), 'label', array("label_attr" => array("class" => "control-label"), "label" => " "));
        echo "
...
";
    ...
    {
        return "TaskBundle:Tasks:edit.html.twig";
    }
