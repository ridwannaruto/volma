...
/* CoreBundle:Home:volunteer.html.twig */
class __TwigTemplate_02f3f451f605d1d33d2afcd98d6a1789fa37a93f5a2fc68dd25a0b8ed569283a extends Twig_Template
{
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["task"]) {
                ...
                echo "                        <tr>
                            <td width=\"20%\">
                                <a href=\"";
                // line 31
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("task_details", array("taskID" => $this->getAttribute((isset($context["task"]) ? $context["task"] : $this->getContext($context, "task")), "id"))), "html", null, true);
                echo "\" > ";
...
";
    ...
    {
        return "CoreBundle:Home:volunteer.html.twig";
    }
