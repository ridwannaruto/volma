...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/morasp5/public_html/volma/app/cache/prod/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/morasp5/public_html/volma/app/cache/prod/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/morasp5/public_html/volma/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/morasp5/public_html/volma/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'morasp5_volma', 'user' => 'morasp5', 'password' => 'MSp@inmh!3102#', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_49d80abaf61bc3f0787de2169d55330b4fe9b31156d1f44e1adfd561dbddd022');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_49d80abaf61bc3f0787de2169d55330b4fe9b31156d1f44e1adfd561dbddd022');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_49d80abaf61bc3f0787de2169d55330b4fe9b31156d1f44e1adfd561dbddd022');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/home/morasp5/public_html/volma/src/Moraspirit/NewsBundle/Resources/config/doctrine' => 'Moraspirit\\NewsBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Moraspirit\\NewsBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('MoraspiritEntityBundle' => 'Moraspirit\\NewsBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/home/morasp5/public_html/volma/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/morasp5/public_html/volma/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/morasp5/public_html/volma/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/morasp5/public_html/volma/app/config/routing.yml', array('cache_dir' => '/home/morasp5/public_html/volma/app/cache/prod', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appProdUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appProdUrlMatcher', 'strict_requirements' => NULL), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/morasp5/public_html/volma/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/morasp5/public_html/volma/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/morasp5/public_html/volma/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/morasp5/public_html/volma/app/cache/prod/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/morasp5/public_html/volma/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/morasp5/public_html/volma/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/morasp5/public_html/volma/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/morasp5/public_html/volma/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/morasp5/public_html/volma/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/morasp5/public_html/volma/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/morasp5/public_html/volma/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/morasp5/public_html/volma/src/Moraspirit/NewsBundle/Resources/views', 'MoraspiritEntity');
        $instance->addPath('/home/morasp5/public_html/volma/src/Moraspirit/StyleBundle/Resources/views', 'MoraspiritStyle');
        $instance->addPath('/home/morasp5/public_html/volma/src/Moraspirit/SiteBundle/Resources/views', 'MoraspiritSite');
        $instance->addPath('/home/morasp5/public_html/volma/src/Moraspirit/UserBundle/Resources/views', 'MoraspiritUser');
        $instance->addPath('/home/morasp5/public_html/volma/src/Moraspirit/EventBundle/Resources/views', 'MoraspiritEvent');
        $instance->addPath('/home/morasp5/public_html/volma/src/Moraspirit/TaskBundle/Resources/views', 'MoraspiritTask');
        $instance->addPath('/home/morasp5/public_html/volma/src/Moraspirit/ProjectBundle/Resources/views', 'MoraspiritProject');
        $instance->addPath('/home/morasp5/public_html/volma/src/Moraspirit/NotificationBundle/Resources/views', 'MoraspiritNotification');
        $instance->addPath('/home/morasp5/public_html/volma/src/Moraspirit/CommentBundle/Resources/views', 'MoraspiritComment');
        $instance->addPath('/home/morasp5/public_html/volma/app/Resources/views');
        $instance->addPath('/home/morasp5/public_html/volma/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/morasp5/public_html/volma/app/../web', true);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/morasp5/public_html/volma/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/morasp5/public_html/volma/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/morasp5/public_html/volma/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/morasp5/public_html/volma/app/cache/prod',
            'kernel.logs_dir' => '/home/morasp5/public_html/volma/app/logs',
            'kernel.bundles' => array(
                ...
                'MoraspiritEntityBundle' => 'Moraspirit\\NewsBundle\\MoraspiritEntityBundle',
                'MoraspiritStyleBundle' => 'Moraspirit\\StyleBundle\\MoraspiritStyleBundle',
                'MoraspiritSiteBundle' => 'Moraspirit\\SiteBundle\\MoraspiritSiteBundle',
                'MoraspiritUserBundle' => 'Moraspirit\\UserBundle\\MoraspiritUserBundle',
                'MoraspiritEventBundle' => 'Moraspirit\\EventBundle\\MoraspiritEventBundle',
                'MoraspiritTaskBundle' => 'Moraspirit\\TaskBundle\\MoraspiritTaskBundle',
                'MoraspiritProjectBundle' => 'Moraspirit\\ProjectBundle\\MoraspiritProjectBundle',
                'MoraspiritNotificationBundle' => 'Moraspirit\\NotificationBundle\\MoraspiritNotificationBundle',
                'MoraspiritCommentBundle' => 'Moraspirit\\CommentBundle\\MoraspiritCommentBundle',
            ),
            ...
            'database_port' => NULL,
            'database_name' => 'morasp5_volma',
            'database_user' => 'morasp5',
            'database_password' => 'MSp@inmh!3102#',
            ...
            'debug.container.dump' => '/home/morasp5/public_html/volma/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/morasp5/public_html/volma/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/morasp5/public_html/volma/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => '/home/morasp5/public_html/volma/app/config/routing.yml',
            ...
            'security.authentication.listener.Base.class' => 'Symfony\\Component\\Security\\Http\\Firewall\\BasicAuthenticationListener',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/morasp5/public_html/volma/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/morasp5/public_html/volma/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/morasp5/public_html/volma/app/cache/prod/assetic',
            ...
            'assetic.read_from' => '/home/morasp5/public_html/volma/app/../web',
            'assetic.write_to' => '/home/morasp5/public_html/volma/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/morasp5/public_html/volma/app/cache/prod/doctrine/orm/Proxies',
