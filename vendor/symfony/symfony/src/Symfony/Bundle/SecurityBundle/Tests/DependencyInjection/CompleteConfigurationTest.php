...
abstract class CompleteConfigurationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testUserProviders()
    {
        ...
        $expectedProviders = array(
            ...
            'security.user.provider.concrete.Base',
        ...
        $this->assertEquals(array(array(
            ...
            new Reference('security.user.provider.concrete.Base'),
    ...
    public function testFirewalls()
    {
        ...
        $this->assertEquals(array(
            ...
            array(
                ...
                'security.authentication.listener.Base.secure',
            ...
            array(
                ...
                'security.authentication.listener.Base.host',
